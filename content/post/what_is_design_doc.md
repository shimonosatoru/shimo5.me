...
## まず「Design Doc」とはなんぞや？

簡潔には「機能仕様書（functional specifications）」です。

もっと言うと

「そのシステム、ソフトウェアがどんな機能をするのかを、ユーザー観点から読みやすくまとめたドキュメント」
になります。
...
と思ったのでatmarkitさんのサイトにいいサンプルがあったので載せておきます。

https://www.atmarkit.co.jp/ait/files/20150206/joel_doc_custom.pdf
